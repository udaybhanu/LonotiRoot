...
curl --header "Authorization: key=$api_key" --header "Content-Type: application/json" https://android.googleapis.com/gcm/send -X POST -d "{\"data\": { \"event\": \"4\"},\"registration_ids\":[\"$reg_id\"]}"
#
